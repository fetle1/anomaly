...
if st.session_state.active_tab == "Upload":
    ...
    st.markdown('<div class="bottom-button-container"> <span></span>'
                + st.button("Next ➡", on_click=lambda: st.session_state.update(active_tab="Preprocessing")) + '</div>', unsafe_allow_html=True)
